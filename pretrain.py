...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type = str, default = 'sleepedf_local.yml') #sleepps18.yml /Users/theb/Desktop/data/HAR/ /Users/theb/Desktop/data/chapman/chapman_preprocessed/ simulated 
